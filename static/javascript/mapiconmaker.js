 ...
 * @class This class represents optional arguments to {@link
 * createMarkerIcon}, 
 *     {@link createFlatIcon}, or {@link createLabeledMarkerIcon}. Each of the
 *     functions use a subset of these arguments. See the function
 *     descriptions
 *     for the list of supported options.
 * @property {Number} [width=32] Specifies, in pixels, the width of the icon.
 *     The width may include some blank space on the side, depending on the
 *     height of the icon, as the icon will scale its shape proportionately.
 * @property {Number} [height=32] Specifies, in pixels, the height of the
 * icon.
 ...
 *     string, the color used for the top corner of the icon. If you'd like
 *     the
 ...
 *     inside the body of the icon. Generally, one or two characters looks
 *     best.
 * @property {String} [labelColor="#000000"] Specifies, as a hexadecimal 
 *     string, the color used for the label text.
 * @property {Number} [labelSize=0] Specifies, in pixels, the size of the
 * label
 ...
 *     options are "circle" for a circle or "roundrect" for a rounded
 *     rectangle.
 * @property {Boolean} [addStar = false] Specifies whether to add a star to
 * the
 *     edge of the icon.
